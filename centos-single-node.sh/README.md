...
This is a Vagrantfile to deploy a **CentOS based** virtual machine using a Virtualbox & VMware provider. 
- Vagrantfile > VMware
- Vagrantfile.txt > VirtualBox

By default will be provisioned one **CentOS 9s** virtual machine.
